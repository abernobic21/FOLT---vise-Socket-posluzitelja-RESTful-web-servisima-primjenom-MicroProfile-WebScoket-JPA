...
<%@ page
	import="java.util.List, edu.unizg.foi.nwtis.podaci.Obracun,edu.unizg.foi.nwtis.podaci.Partner"%>
<!DOCTYPE html>
<html>
<head>
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
<title>REST MVC - Pregled obračuna partnera</title>
<link rel="stylesheet"
	href="${pageContext.servletContext.contextPath}/resources/css/nwtis.css">
</head>

<body>
	<div class="main-wrapper" style="margin-left: 270px; padding: 20px;">

		<h1>REST MVC - Pregled obračuna partnera</h1>
		...
		<div class="section-container">
			...
			<form id="filterForma" onsubmit="return false;">
				<label for="vrijemeOd">Od:</label> <input type="datetime-local"
					...
					for="partner">Partner:</label> <select id="partner" name="partner">
					<%
					...
					%>
					<option value="">Nema partnera</option>
					<%
					}
					%>
				</select>
	...
	function dohvatiObracune() {
	    ...
	    let url = window.location.pathname +"/" + partnerId;
	    let params = [];
